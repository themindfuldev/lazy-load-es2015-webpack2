...
// Rendering cat
let myCat = new __WEBPACK_IMPORTED_MODULE_0__cat__["a" /* default */]( 'Bugsy' );
...
document.getElementById( 'loadZoo' ).addEventListener( 'click', e => {
  ...
  __webpack_require__.e/* System.import */(1).then(__webpack_require__.bind(null, 2)).then( Zoo => {
